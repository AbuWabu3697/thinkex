/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5348c83093b741e804d43d2ed057d3fa)
...
interface __BaseEnv_Env {
	...
	R2_BUCKET_NAME: "thinkex-workspace-kernel-files-staging" | "thinkex-workspace-kernel-files";
	...
	WORKSPACE_UPLOAD_TOKEN_SECRET: string;
	...
	CODE_SANDBOX: DurableObjectNamespace<import("./src/server").Sandbox>;
	OFFICE_PDF_CONVERTER: DurableObjectNamespace<import("./src/server").OfficePdfConverter>;
	WORKSPACE_FILE_PROCESSOR: DurableObjectNamespace<import("./src/server").WorkspaceFileProcessor>;
	WORKSPACE_FILE_EXTRACTION_WORKFLOW: Workflow<Parameters<import("./src/server").WorkspaceFileExtractionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "UserAIStore" | "WorkspaceKernel" | "DocumentSession" | "OfficePdfConverter" | "Sandbox" | "WorkspaceFileProcessor";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIRECRAWL_API_URL" | "R2_BUCKET_NAME" | "SANDBOX_TRANSPORT" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FIRECRAWL_API_KEY" | "LLAMA_CLOUD_API_KEY" | "AI_GATEWAY_API_KEY" | "AUTUMN_SECRET_KEY" | "TCC_API_KEY" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "WORKSPACE_UPLOAD_TOKEN_SECRET">> {}
}
